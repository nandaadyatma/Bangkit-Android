...
class OptionDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnChoose = view.findViewById<Button>(R.id.btn_choose)
        btnClose = view.findViewById<Button>(R.id.btn_close)
        rgOptions = view.findViewById<RadioGroup>(R.id.rg_options)
        rbSaf = view.findViewById<RadioButton>(R.id.rb_saf)
        rbMou = view.findViewById<RadioButton>(R.id.rb_mou)
        rbLvg = view.findViewById<RadioButton>(R.id.rb_lvg)
        rbMoyes = view.findViewById<RadioButton>(R.id.rb_moyes)
